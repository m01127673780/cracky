              ...
              <div class="card">
                ...
                <div class="card-body p-0">
                  <ul class="users-list clearfix">
                    ...
                    <li>
                      <img src="{{url('design/adminlte')}}/dist/img/user8-128x128.jpg" alt="User Image">
                      <a class="users-list-name" href="#">Norman</a>
                      <span class="users-list-date">Yesterday</span>
                    </li>
                    <li>
                      <img src="{{url('design/adminlte')}}/dist/img/user7-128x128.jpg" alt="User Image">
                      <a class="users-list-name" href="#">Jane</a>
                      <span class="users-list-date">12 Jan</span>
                    </li>
                    <li>
                      <img src="{{url('design/adminlte')}}/dist/img/user6-128x128.jpg" alt="User Image">
                    ...
                    <li>
                      <img src="{{url('design/adminlte')}}/dist/img/user5-128x128.jpg" alt="User Image">
              ...
              <ul class="products-list product-list-in-card pl-2 pr-2">
                <li class="item">
                  <div class="product-img">
                    <img src="{{url('design/adminlte')}}/dist/img/default-150x150.png" alt="Product Image" class="img-size-50">
                  </div>
