...
<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#del_departments{{$id}}">
    <i class="fa fa-trash"></i>
</button>

<!-- Modal -->
<div class="modal fade" id="del_departments{{$id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p> {{trans('admin.delete_this',['name'=>session('lang')== 'ar'?$dep_name_ar:$dep_name_en])}}</p>
                           @if(empty($icon))
