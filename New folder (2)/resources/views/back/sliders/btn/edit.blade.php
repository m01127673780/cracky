...
<button type="button" class="btn btn-info" data-toggle="modal" data-target="#edit_sliders{{ $id }}"><i class="fa fa-edit"></i></button>
<!-- Modal -->
<div id="edit_sliders{{ $id }}" class="modal fade" role="dialog">
                             ...
                             <!--        {{ Form::button('<i class="fa fa-location-arrow "> '
                                   ...
                                   <div class="col-md-6 content_form_ar" >
                                    <div class="form-group d-none">
                                        ...
                                        {!! Form::text('head_ar',$head_ar,['class'=>'form-control','class'=>'form-control' ]) !!}
                                    ...
                                    <div class="form-group d-none">
                                        ...
                                        {!! Form::text('text1_ar',$text1_ar,['class'=>'form-control','class'=>'form-control' ]) !!}
                                    </div><!-- /.form-group text1_ar -->
                                    <div class="form-group d-none">
                                        {!! Form::label('text2_ar',trans('admin.text2_ar')) !!}
                                        {!! Form::text('text2_ar',$text2_ar,['class'=>'form-control','class'=>'form-control' ]) !!}
                                    </div><!-- /.form-group text2_ar -->
                                    <div class="form-group d-none">
                                        {!! Form::label('text3_ar',trans('admin.text3_ar')) !!}
                                        {!! Form::text('text3_ar',$text3_ar,['class'=>'form-control','class'=>'form-control' ]) !!}
                                    </div><!-- /.form-group text3_ar -->
                                   ...
                                   <div class="form-group d-none">
                                        ...
                                        {!! Form::text('head_en',$head_en,['class'=>'form-control','class'=>'form-control' ]) !!}
                                    </div><!-- /.form-group head_en --> 
                                      <div class="form-group d-none">
                                  ...
                                  <div class="form-group d-none">
                                    ...
                                    <div class="form-group d-none">
                                        ...
                                        {!! Form::text('text1_en',$text1_en,['class'=>'form-control','class'=>'form-control' ]) !!}
                                    </div><!-- /.form-group text1_en -->
                                    <div class="form-group d-none">
                                        {!! Form::label('text2_en',trans('admin.text2_en')) !!}
                                        {!! Form::text('text2_en',$text2_en,['class'=>'form-control','class'=>'form-control' ]) !!}
                                    </div><!-- /.form-group text2_en -->
                                    <div class="form-group d-none">
                                        {!! Form::label('text3_en',trans('admin.text3_en')) !!}
                                        {!! Form::text('text3_en',$text3_en,['class'=>'form-control','class'=>'form-control' ]) !!}
                                    </div><!-- /.form-group text3_ar -->
